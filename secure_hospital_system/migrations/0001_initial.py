# Generated by Django 3.2.5 on 2022-03-29 00:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Patient',
            fields=[
                ('patient_id', models.BigAutoField(default=None, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Claim_Request',
            fields=[
                ('claim_id', models.BigAutoField(default=None, primary_key=True, serialize=False)),
                ...
                ('patient_id', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='secure_hospital_system.patient')),
                ('payment_id', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='secure_hospital_system.payments')),
            ],
        ),
    ]
