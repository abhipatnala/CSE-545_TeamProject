...
urlpatterns = [
    ...
    path('bookAppointmentForSelectedDoc',views.bookAppointmentForSelectedDoc, name ='bookAppointmentForSelectedDoc'),
    ...
    path('bookingAppointmentsForSelectedDocByExistingPatients',views.bookingAppointmentsForSelectedDocByExistingPatients, name ='bookingAppointmentsForSelectedDocByExistingPatients'),
