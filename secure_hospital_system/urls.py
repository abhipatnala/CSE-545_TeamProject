...
urlpatterns = [
    ...
    path('appointmentDeniedMail/<int:booking_id>',views.appointmentDeniedMail, name ='appointmentDeniedMail'),    path('appointmentconf', TableView.as_view(),name ='appointmentconf'),
