...
class Patient(models.Model):
    patient_id = models.BigAutoField(primary_key=True, default = None)
...
class Claim_Request(models.Model):
    claim_id = models.BigAutoField(primary_key=True, default=None, blank=True)
    payment_id = models.ForeignKey(Payments, on_delete=models.CASCADE, default=None, blank=True, null=True)
    claim_status = models.CharField(max_length=200, choices=APPOINTMENT_STATUS, default='pending')
    patient_id = models.ForeignKey(Patient, on_delete=models.CASCADE, default=None, blank=True, null=True)
    claim_raised_date = models.DateTimeField(default = '1997-08-15 15:36:38')